...
export default function Login() {
  ...
  return (
    ...
    >
      ...
      <section
        data-aos="fade-left"
        className=" flex  items-center justify-center rounded-t-3xl lg:rounded-none p-2"
      >
        <SpotlightCard
          className="custom-spotlight-card w-full max-w-md p-8"
          spotlightColor="rgba(255, 105, 180, 0.60)"
        >
          <div className=" ">
